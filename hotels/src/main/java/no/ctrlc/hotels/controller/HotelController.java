...
public class HotelController {
	...
	public String hotelSearch(Model model) {
		//--TODO implement a proper search like in customer search instead of returning a list.		
	...
	public String hotelSelect(
		...
		// if we change hotel we need to discard the room which belongs to the current new order.
		order.setRoom(null);
