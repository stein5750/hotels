...
public class OrderController {
    ...
    @RequestMapping(path = "/order", params = "action=Create order", method = RequestMethod.POST)
    public String createOrder( @Validated(Order.FirstStep.class) @ModelAttribute("order") Order order,
    ...
    @RequestMapping(path = "/order", params = "action=Edit order", method = RequestMethod.POST)
    public String EditOrder() {
        // return view
        return "redirect:/servlet/home/home";
    }

    @RequestMapping(path = "/order", params = "action=Cancel order", method = RequestMethod.POST)
    ...
    @RequestMapping(path = "/order", params = "action=Save order", method = RequestMethod.POST)
    public String saveOrder( @Validated(Order.FirstStep.class) @ModelAttribute("order") Order order,
    ...
    @RequestMapping(path = "/order", params = { "action=Show order" }, method = RequestMethod.POST)
    ...
    @RequestMapping(path = "/order", params = { "action=Delete" }, method = RequestMethod.POST)
    public String showOrder( @ModelAttribute("order") Order order, @RequestParam UUID orderId, Model model) {
    ...
    @RequestMapping(path = "/order", params = "action=Orders", method = RequestMethod.POST)
    public String customerShowOrders( @ModelAttribute("order") Order order, Model model) {
        if (order.getCustomer() == null) {
            model.addAttribute("error.preRequirement",
                    new String("Choose a customer before trying to show customers orders"));
            return "home";
        }
        // This customers orders
